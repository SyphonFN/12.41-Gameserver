...
static_assert(offsetof(M_LRG_Buff_Cat_FaceAcc_AnimBp_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'M_LRG_Buff_Cat_FaceAcc_AnimBp_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
