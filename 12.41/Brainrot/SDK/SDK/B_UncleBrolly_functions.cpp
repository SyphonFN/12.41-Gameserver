...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   Param_CurrentPoise                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_UncleBrolly_C::CurrentPoiseChanged(float Param_CurrentPoise)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_CurrentPoise = Param_CurrentPoise;
