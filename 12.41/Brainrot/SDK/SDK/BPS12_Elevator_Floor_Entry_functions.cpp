...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EAthenaSpatialElevatorState             Param_ElevatorState                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBPS12_Elevator_Floor_Entry_C::SetStyleImgePortait(EAthenaSpatialElevatorState Param_ElevatorState)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_ElevatorState = Param_ElevatorState;
...
void UBPS12_Elevator_Floor_Entry_C::SetIconRimBrushColor(EAthenaSpatialElevatorState Param_ElevatorState)
{
	static class UFunction* Func = nullptr;
