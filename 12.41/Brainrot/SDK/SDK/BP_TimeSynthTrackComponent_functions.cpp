...
void UBP_TimeSynthTrackComponent_C::SetController(class ABP_TimeSynthController_Base_C* Param_TimeSynthController)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// TArray<struct FTimeSynth_TrackStemData> Param_Clips                                            (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
// int32                                   Duration                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_TimeSynthTrackComponent_C::CalculateTrackLengthBeats(TArray<struct FTimeSynth_TrackStemData>& Param_Clips, int32* Duration)
{
	static class UFunction* Func = nullptr;
