...
void UAthenaMatchmakingSpinnerButton_C::OnSpinnerValueChanged__DelegateSignature(int32 Param_Index)
{
...
void UAthenaMatchmakingSpinnerButton_C::Highlight(bool Param_Highlight)
{
	static class UFunction* Func = nullptr;
