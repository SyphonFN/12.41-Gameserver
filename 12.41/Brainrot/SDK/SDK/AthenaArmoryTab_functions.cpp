...
void UAthenaArmoryTab_C::BeginPickingCustomization(class UCommonButton* WidgetToReturnFocusTo, const struct FAthenaCustomizationParams& Param_CustomizationParams)
{
	static class UFunction* Func = nullptr;
...
void UAthenaArmoryTab_C::OkToReshowOnHover(EAthenaCustomizationCategory Type, int32 Param_Index, bool* Ok)
{
	static class UFunction* Func = nullptr;
