...
// Parameters:
// struct FHenchmenData                    Param_HenchmenData                                     (BlueprintVisible, BlueprintReadOnly, Parm)
// class AFortPlayerController*            Param_Owner                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   State                                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABPS12_Elevator_Outerdoor_Indicator_C::Set_Henchmen_State(const struct FHenchmenData& Param_HenchmenData, class AFortPlayerController* Param_Owner, int32* State)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_HenchmenData = std::move(Param_HenchmenData);
