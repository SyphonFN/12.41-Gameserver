...
void AB_Uncle_Brolly_Block_Collision_C::RemovalChecks(class AFortPlayerPawn* Param_PlayerPawn)
{
	static class UFunction* Func = nullptr;
...
void AB_Uncle_Brolly_Block_Collision_C::ExecuteBlockGameplayCue(float Damage, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext, class AActor* Param_Instigator, const struct FHitResult& HitResult, bool* WasGalileoBun)
{
	static class UFunction* Func = nullptr;
...
// class ACharacter*                       Param_Instigator                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_Uncle_Brolly_Block_Collision_C::BlockedUncleImpulse(const struct FHitResult& HitInfo, class ACharacter* Param_Instigator)
{
	static class UFunction* Func = nullptr;
